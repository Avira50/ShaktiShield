# **App Name**: ShaktiShield

## Core Features:

- Anonymous Issue Submission: Allow users to report issues anonymously, ensuring their identity is protected.
...
- Primary color: Soft lavender (#E6E6FA) to create a sense of calm and safety.
- Background color: Very pale lavender (#F5F5FF), near-white, to complement the soft lavender, in keeping with a light color scheme.
- Accent color: Muted Teal (#70A1A1) as a complementary color to the lavender for interactive elements.
- Body and headline font: 'Inter', a grotesque-style sans-serif font suitable for body text and headlines.
- Use simple, easily recognizable icons that reinforce the portal's safety and confidentiality focus.
- Design a clean, intuitive layout with clear navigation to make it easy for students to report issues and track their status.
- Implement subtle animations and transitions to provide gentle feedback and enhance the user experience.